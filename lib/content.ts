 ...
 *
 * Sections are props-only: nothing below `components/sections` imports from
 * this file. `app/page.tsx` reads it and passes each section its content, so
 * the writing can be edited, restaged or swapped for a CMS without touching
 * layout.
 */
